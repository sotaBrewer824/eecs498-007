...
def create_tensor_of_pi(M: int, N: int) -> Tensor:
    ...
    # Replace "pass" statement with your code
    """
    Function Name: torch.full:
    Parameters:
      * size (int...) – a list, tuple, or torch.Size of integers 
...
def slice_assignment_practice(x: Tensor) -> Tensor:
    ...
    # Replace "pass" statement with your code
    x[:2, 1], x[:2, 2:6]= 1, 2
    x[2:4, 0:4:2], x[2:4, 1:4:2], x[2:4, 4:6]= 3, 4, 5
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return x
...
def take_one_elem_per_col(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    idxs0, idxs1 = [1, 0, 3], [range(3)]
    y = x[idxs0, idxs1].reshape(-1)
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return y
...
def reshape_practice(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    x0, x1= x.reshape(2, 3, 4)[0], x.reshape(2, 3, 4)[1]
