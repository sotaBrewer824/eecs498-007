...
def content_loss(content_weight, content_current, content_original):
    ...
    lc = torch.sum(content_weight * (content_current - content_original)**2)
    return lc
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def gram_matrix(features, normalize=True):
    ...
    gram = features.matmul(features.permute(0, 2, 1)) * w
...
def style_loss(feats, style_layers, style_targets, style_weights):
    ...
    for i, layer in enumerate(style_layers):
      ...
      loss += style_weights[i] * ((gram_mat-style_targets[i])**2).sum()
    return loss
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
